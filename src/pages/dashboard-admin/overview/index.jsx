...
import { FaUsers, FaChalkboardTeacher, FaDollarSign, FaFileAlt } from "react-icons/fa";
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 sm:p-6 lg:p-8">
      <header className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Welcome back! Here's your latest analytics</p>
      </header>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-semibold text-gray-800">User Registration Trends</h2>
          <select
            value={dateRange}
