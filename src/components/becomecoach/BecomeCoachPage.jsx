...
const BecomeCoachPage = () => {
  ...
  return (
    <div className="become-coach-page min-h-screen flex items-center justify-center bg-gray-50 p-4">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div>
            <textarea
              ...
              rows={4}
              className={`w-full border p-3 rounded ${errors.experience ? "border-red-500" : "border-gray-300"
                }`}
            />
            {errors.experience && (
