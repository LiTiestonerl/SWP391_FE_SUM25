...
const QuitPlan = () => {
    ...
    return (
        <div className="min-h-screen p-6 bg-gradient-to-br from-[#c3e4dd] via-[#dfeee5] to-[#a1cfc1] text-gray-800">
            <div className="max-w-7xl mx-auto week-card-container">
                ...
                <div className="flex items-center mb-6">
                    <button
                        ...
                        className="p-2 rounded-full text-gray-500 hover:text-emerald-600 mr-3 hover:bg-gray-100 transition mt-19"
                        title="Back to Overview"
                    >
                        ←
                    </button>
                    <h2 className="text-2xl font-bold text-emerald-700 drop-shadow-sm mt-19">
                        Quit Plan Detail
                    </h2>
                </div>
